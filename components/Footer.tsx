        ...
        <div className="container">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
            <div className="footer-info">
              <Link
                href="/"
                className="items-center mb-4 text-xl font-bold flex gap-2 text-amber-600"
              >
                <CiForkAndKnife className="text-white" />
                <span>FootSpot</span>
              </Link>
              <p className="text-gray-400 mb-4">
                Discover the best restaurants in your area. FoodSpot helps you
                find and manage your favorite dining destinations.
              </p>
